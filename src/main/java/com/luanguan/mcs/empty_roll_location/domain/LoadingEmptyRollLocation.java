...
public class LoadingEmptyRollLocation extends EmptyRollLocation {
    ...
    public LoadedEmptyRollLocation handle(MissionCompleted missionCompleted) {
    ...
    public UnloadedEmptyRollLocation handle(MissionFailed missionFailed) {
